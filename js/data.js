// js/data.js – Demo Seed-Daten (nur wenn keine DATA vorhanden)
(function(){
  if (window.DATA && Array.isArray(window.DATA.sets)) return;

  const sets = [
    { id:1, code:'ACH-101', name:'Standard-OP Set', department:'Chirurgie', status:'Freigegeben',
      image_url:'' },
    { id:2, code:'ACH-102', name:'Laparoskopie Set', department:'Chirurgie', status:'Freigegeben',
      image_url:'' },
    { id:3, code:'ACH-103', name:'Orthopädie Standard', department:'Ortho', status:'Freigegeben',
      image_url:'' }
  ];
